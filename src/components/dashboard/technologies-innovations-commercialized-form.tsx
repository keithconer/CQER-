...
import { CalendarIcon, ChevronLeft, ChevronRight, Cpu, FileUp, FlaskConical, Save, X } from "lucide-react";
        ...
        <div className="border-b border-border/40 bg-background px-4 py-3 sm:px-6 lg:px-8">
          <div className="flex w-full items-start justify-between gap-4">
            <h1 className="text-xl font-bold text-foreground">
              {initialData?.id ? (isViewOnly ? "Technologies / Innovations Commercialized Details" : "Update Technologies / Innovations Commercialized") : "Create Technologies / Innovations Commercialized"}
            </h1>
            {onClose && (
          ...
          <div className="mt-3 grid gap-3 lg:grid-cols-3">
            <div className="rounded-xl border border-border/40 bg-muted/10 px-4 py-2.5">
              <p className="text-[10px] uppercase tracking-wider text-muted-foreground/80">Technology</p>
              <p className="truncate text-xs font-medium text-foreground">{form.watch("technology_name") || "Unassigned"}</p>
            </div>
            <div className="rounded-xl border border-border/40 bg-muted/10 px-4 py-2.5">

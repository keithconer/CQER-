      ...
      <div className="flex items-center justify-between border-b px-6 py-4">
        <div>
          <h2 className="text-xl font-semibold">
            {isViewOnly ? "Awards and Recognition Details" : record ? "Edit Awards and Recognition" : "Manage Extension"}
          </h2>
          <p className="text-sm text-muted-foreground">
            Record awards and recognitions using the same fullscreen workflow as the other project leader forms.
          </p>
        </div>
